...
<ol class="breadcrumb mt-0 mb-4" style="background-color:#9bcf21">
    <font face="Comic Sans MS,arial,verdana">Seccion de reporte de deudas de usuario | FEUNAS </font>
</ol>
        ...
        <main>
            <div class="container-fluid" style="background-color:#d0ddeb">
                ...
                <div class="card mb-4">
                    ...
                    <a href="inasistencias" style="margin-left:80%">Ver Inasistencias</a>
                </div>
            </div>    
        </main>
